$(function($) {
    ...
    var dirName = ['Top', 'Right', 'Bottom', 'Left'],
        angle = 90,
        turnCount = 0,
        imgs = ['images/yellow-mountains-532857_1920.jpg', 'images/basaltic.jpg', 'images/panorama-1993645_1280.jpg'],
        skills = [{
                name: 'Javascript',
                score: 85
            },
    ...
    $('div.cubesContainer').hover(mouseIn, mouseOut).click(cubeClick);
